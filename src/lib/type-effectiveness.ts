// Type effectiveness chart: [attacking][defending] = multiplier
...
// Returns effectiveness multiplier for attackingType vs defendingType
export function getTypeEffectiveness(attacking: string, defending: string): number {
  return TYPE_EFFECTIVENESS[attacking]?.[defending] ?? 1;
}
